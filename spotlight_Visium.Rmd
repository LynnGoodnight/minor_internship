...
# DimPlot(sc_dataset_filtered, group.by = "subclass", label = TRUE)
...
p = SpatialFeaturePlot(spatial, features = c("B_mem", "B_naive","B_plasma"), pt.size.factor = 1.6, ncol = 3, crop = TRUE)
print(p)
p = SpatialFeaturePlot(spatial, features = c("FDC", "ILC"), pt.size.factor = 1.6, ncol = 2, crop = TRUE)
print(p)
